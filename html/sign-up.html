...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="C:\xampp\htdocs\lanmessanger\css\sign-up.css">
    <title>sign-up</title>
</head>
...
<body>
    <div class="container">
        <div class="form-container">
            <div class="logo">
                <img src="C:\xampp\htdocs\lanmessanger\images\logo.png" alt="Logo">
            </div>
            ...
            <form action="datasave.php" class="form-input" method="post">
                ...
                <div class="form-in-item">
                    ...
                    <input class="form-item" type="password" name="" placeholder="confirm password">
                </div>
                <div class="btn">
                    <input type="submit">
                    <input class="form-btn" type="reset" value="RESET" name="reset">
                </div>
                <div class="sign-in"><p>if you have already an account? <a href="C:\xampp\htdocs\lanmessanger\html\sign-in.html">sign-in</a></p></div>
            </form>
        </div>
    </div>
</body>
